...
| **`parallel-orchestrator`** ★v2.6 | 拿 DAG 后 fan-out → fan-in → 整合 | 主 session |
| **`agent-coding-discipline`** ★v2.4 | **任何写码 agent 动手前必读**(10 规则 + 4 失败模式 + 9 项 pre-submit) | 所有 implementer/explorer/verifier |
